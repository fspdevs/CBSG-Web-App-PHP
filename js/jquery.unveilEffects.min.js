!(function(t) {
  (t.fn.unveilEffect = function(n, i) {
    ...
    (unveilEffectSettings = t.extend(
      ...
      "undefined" != typeof unveilEffectSettings ? unveilEffectSettings : !1
    )),
    t(function() {
      if (
        ((t.fn.unveilEffect.transition = (function() {
        ...
        n.each(function() {
          var n = t(this),
            i = n.data("effect");
          n.addClass("effect-" + i)[0].offsetWidth,
            n.css(
              t.fn.unveilEffect.transition.css,
              "all " +
                unveilEffectSettings.transitionDuration +
                "s " +
